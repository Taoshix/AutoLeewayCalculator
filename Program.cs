    ...
    public static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            start:
                ...
                Console.Write("Input mods, ?, or leave blank for 4 mod and then press ENTER: ");
                ...
                while (true)
                {
                    ...
                    PrintSettings(Settings, true);
                    Console.Write("Input new mods, ?, or leave blank for 4 mod and then press ENTER to continue: ");
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        Console.Title = "AutomaticLeewayCalculator - Manual Mode - " + beatmapId;
